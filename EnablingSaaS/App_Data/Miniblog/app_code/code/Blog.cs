...
public static class Blog
{
    ...
    private static string _copywrightOwner = ConfigurationManager.AppSettings.Get("blog:copyrightOwner");
    ...
    public static string CopywrightOwner
    {
        get { return _copywrightOwner; }
    }
